<?php $view->script(
	'ban-edit',
	'spqr/security:app/bundle/ban-edit.js',
	[
		'vue',
		'editor'
	]
...
<form id="ban" class="uk-form" v-validator="form" @submit.prevent="save | valid" v-cloak>
	<div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
		<div data-uk-margin>
			<h2 class="uk-margin-remove" v-if="ban.id">{{ 'Edit Ban' | trans }}</h2>
